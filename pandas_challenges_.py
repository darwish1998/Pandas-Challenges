# -*- coding: utf-8 -*-
"""pandas-challenges .ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Lb7zfdAME9VQgKIczBcMoA8psFqO0piP
...
round(hotels['total_stay_nights'].mean(),1)
...
# CODE HERE
hotels['total_cost'] = hotels['adr'] * hotels['total_stay_nights']
...
# CODE HERE
hotels[hotels['total_of_special_requests'] == 2][['name','email']]
...
hotels['name'].apply(grap_name).value_counts()
...
#CODE HERE
hotels['phone-number'].apply(lambda num: num[:3]).value_counts()
...
#CODE HERE
hotels['arrival_date_day_of_month'].isin(range(1,26)).value_counts()
...
hotels['date']=np.vectorize(convert_date)(hotels['arrival_date_day_of_month'],hotels['arrival_date_month'],hotels['arrival_date_year'])
